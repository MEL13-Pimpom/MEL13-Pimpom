      ...
      <div className="space-y-6 max-w-4xl">
        ...
        <Card>
          <CardContent className="p-12 text-center">
            ...
            <p className="text-muted-foreground">
              No active route assigned. Check back later or contact your
              administrator.
            </p>
          </CardContent>
        </Card>
  ...
  return (
    <div className="space-y-6 max-w-6xl">
      <div>
        ...
        <p className="text-muted-foreground">
          {route.name} • {format(parseISO(route.scheduled_date), "EEEE, MMM d, yyyy")}
        </p>
      </div>
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between">
          ...
          <RouteControls routeId={route.id} status={route.status} canComplete={allDone} />
        </CardHeader>
        <CardContent>
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 text-sm text-muted-foreground">
                          ...
                          {stop.request?.weight_kg_estimate != null && (
                            <div className="flex items-center gap-2">
                              ...
                              <span>{stop.request.weight_kg_estimate} kg</span>
                            </div>
                          )}
                        </div>
